...
@section('content')
    ...
    <form method="post" action="/company-save/{{$company->id}}" enctype="multipart/form-data">
        {{csrf_field()}}
        ...
        <div class="row m-2">
            ...
            <div class="col-md-6 offset-3 ">
                <div class="form-group">
                    <h2 class="title is-2">Редактирование  компании</h2>
                </div>
                <div class="form-group">
                    <label for="name"> <h4 class="subtitle is-5">Название:</h4>
                    </label>

                    <input class="form-control"
                           type="text" name="name" placeholder="Название" value="{{$company->name}}"/>
                </div>
                ...
                <div class="form-group">
                    ...
                    <input class="form-control "
                           type="email" name="email" placeholder="Email" value="{{$company->email}}"/>
                </div>
